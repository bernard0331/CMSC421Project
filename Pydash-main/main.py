...
def get_progress_percentage():
    global fill, BAR_LENGTH
    return fill / BAR_LENGTH * 100
...
while not done:
    ...
    # Calculate progress and optionally print or display it
    # KNOWN ISSUE: Progress bar is not relative to end of level
